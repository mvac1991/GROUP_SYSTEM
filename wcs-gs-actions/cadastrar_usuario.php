...
<?php
	...
	{
		$criar_tabela .= "create table $tabela(codigo int auto_increment, nome text, login text, cpf text, telefone text, email text, funcao text, senha text, primary key(codigo))"; 
